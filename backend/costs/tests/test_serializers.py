...
class MutableCostSerializerTest(TestCase):
    """Case of testing mutable cost seiralizer"""
    ...
    def setUp(self):
        ...
        self.serializer = MutableCostSerializer(self.cost)
...
class ImmutableCostSerializerTest(TestCase):
    """Case of testing immutable cost seiralizer"""
    ...
    def setUp(self):
        ...
        self.serializer = ImmutableCostSerializer(self.cost)

    def test_has_serializer_all_needed_fields(self):
        self.assertEqual(self.serializer.data['pk'], str(self.cost.pk))
        self.assertEqual(self.serializer.data['title'], 'test_cost')
        self.assertEqual(self.serializer.data['costs_sum'], '100.00')
        self.assertEqual(dict(self.serializer.data['category']), {
