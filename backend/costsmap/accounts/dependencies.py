...
from .models import UserNamedTuple
from .schemas import (
...
async def get_current_user(token: str = Depends(oauth)) -> UserNamedTuple:
...
async def change_user(
    changing_data: UserIn, current_user: UserNamedTuple = Depends(get_current_user)
) -> UserOut:
